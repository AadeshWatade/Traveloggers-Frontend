...
const TopBlogCard = ({ title }) => {
    return (
        <div className='relative cursor-pointer min-w-[300px] border rounded-lg'>
            <img className='!max-h-52 w-full rounded-t-lg' src='https://images.unsplash.com/photo-1639776571978-fd41fece893b?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1471&q=80' alt="" />
