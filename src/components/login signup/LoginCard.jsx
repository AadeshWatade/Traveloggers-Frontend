...
const LoginSignupCard = () => {
    return (
        <div className='grid grid-cols-1 md:grid-cols-2 justify-center z-10 mx-auto w-5/6 md:w-[60%] pt-16'>
            ...
            <div className='bg-acccentColor p-10 text-center rounded-3xl md:rounded-r-3xl md:rounded-l-none'>
                ...
                <div className='flex flex-col space-y-16 mt-16 md:mx-6'>

                    <Input placeholder='Enter Email/Username' type='text' />
                    <Input placeholder='Password' type='password' />
                </div>
                <p className='text-xs text-black/80 text-right mt-1 md:mx-6 hover:text-black hover:underline'>Forgot Password?</p>
                <div className='flex flex-col'>
                    <button className=' bg-white text-accentColbg-acccentColor rounded-full md:px-16 py-2 mt-10 w-1/2 text-xl mx-auto'>Login</button>
